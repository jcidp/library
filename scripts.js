...
function toggleBookRead(e) {
  ...
  e.target.parentElement.previousElementSibling.lastElementChild.textContent =
    getPropText("read", myLibrary[index]);
}
...
function validateForm() {
  ...
  let error;
  if (title.validity.valueMissing) error = "Please include a title";
  else if (author.validity.valueMissing) error = "Please include an author";
  else if (pages.validity.valueMissing)
    error = "Please include the number of pages";
